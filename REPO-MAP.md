...
| /generate-repo-map | `skills/generate-repo-map/SKILL.md` | 112 | Regenerate REPO-MAP.md by scanning current skills, agents, and command |
...
| /migrate-from-notion | `skills/migrate-from-notion/SKILL.md` | 191 | One-shot migration of legacy Notion product data (Decisions, Signals,  |
| /pipeline | `skills/pipeline/SKILL.md` | 159 | Read-only view of the sales pipeline from data/leads/. Groups leads by |
| /pm-digest | `skills/pm-digest/SKILL.md` | 154 | Search the web for the latest PM + AI news, discussions, and best prac |
...
| `dev-standards.md` | 173 | Authoring or reviewing skills, agents, submodule infrastructure |
