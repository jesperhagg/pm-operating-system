...
- `tasks/governance.md` — conflict and staleness tasks written by
  `/context-sync`. Review-only from this skill.
...
**Triggers:** `/tasks`, session start, "what am I working on", "what's active"
...
- If backlog is large (>15 active): "Want to run `/break-down` to
  tighten scope?"
